...
<div class="container">
	...
	<h2>Formularz rejestracji</h2>
        <form class="form-horizontal" role="form" method="get" action="AddApplicantServlet">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label" for="usr">Confirm Password</label>
                <div class="col-sm-8">
                    <input type="password" class="form-control" id="usr" placeholder="" name="password2" required>
                </div>
            </div>
			<div class="form-group">
              <label class="col-sm-4 control-label" for="usr">Email</label>
                <div class="col-sm-8">
                    <input type="email" class="form-control" id="usr" placeholder="" name="email" required>
                </div>
            </div>
            <div class="form-group">        
